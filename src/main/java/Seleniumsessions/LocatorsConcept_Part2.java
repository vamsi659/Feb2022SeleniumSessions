...
public class LocatorsConcept_Part2 {
	...
	public static void main(String[] args) {
		...
		// 1. id: unique Attribute : cannot be duplicate -- I
		// 2. name: can be duplicate (attribute) -- II
...
//		driver.findElement(By.xpath("//*[@id=\"content\"]/div/div[2]/div/form/input")).click();   // clicking a button
						// OR// By locator method
...
//		driver.findElement(By.cssSelector("#content > div > div:nth-child(2) > div > form > input")).click();
		...
		// 6. linkText: is only for links //"<a" anchor tag : If there is an anchor tag, we can use the below approach
//		Register
//		Register
